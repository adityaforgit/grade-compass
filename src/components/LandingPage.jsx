        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="relative max-w-5xl mx-auto text-left">
            ...
            <div
              ...
              className="bg-white rounded-3xl border border-slate-200/90 shadow-2xl shadow-slate-200/60 overflow-hidden transition-all"
            >
              {/* Top Window Chrome Bar with Sliding Navigation Controls */}
              <div className="bg-slate-50/90 border-b border-slate-200/80 px-4 sm:px-6 py-3.5 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="hidden sm:flex items-center space-x-2 text-xs font-semibold text-slate-500 pl-2 border-l border-slate-200">
                    ...
                    <span>•</span>
                    <span className="text-blue-600 font-medium">Interactive Showcase</span>
                  </div>
                </div>

                {/* Minimalist Segmented Slide Switcher */}
                <div className="flex items-center bg-slate-200/60 p-1 rounded-xl shadow-2xs">
                  <button
                    type="button"
                ...
                <div className="flex items-center space-x-1.5">
                  <button
                    ...
                    className="w-8 h-8 rounded-lg bg-white border border-slate-200 text-slate-600 hover:text-slate-900 hover:bg-slate-100 flex items-center justify-center transition-all cursor-pointer shadow-2xs"
                  >
                ...
                >
                  ...
                  <div className="w-full flex-shrink-0 p-6 sm:p-8 flex flex-col justify-between space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
                      <div>
                        ...
                        <div className="flex items-center space-x-2 text-xs text-slate-500 mt-1">
                          ...
                          <span>•</span>
                          <span className="font-semibold text-slate-700">3 Credits</span>
                        </div>
                      </div>

                      <div className="bg-slate-50 border border-slate-200/80 rounded-2xl px-4 py-2 text-right self-start sm:self-auto shadow-2xs">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
                        {/* CA1 */}
                        <div className="bg-slate-50/70 border border-slate-200/90 rounded-2xl p-3.5 focus-within:bg-white focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/10 transition-all shadow-2xs">
                          ...
                          <input
                            ...
                            className="w-full text-lg font-black text-slate-900 bg-transparent focus:outline-none"
                          />
                          <span className="text-[10px] text-slate-400 block mt-1">Class Test 1</span>
                        </div>
                        ...
                        <div className="bg-slate-50/70 border border-slate-200/90 rounded-2xl p-3.5 focus-within:bg-white focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/10 transition-all shadow-2xs">
                          ...
                          <input
                            ...
                            className="w-full text-lg font-black text-slate-900 bg-transparent focus:outline-none"
                          />
                          <span className="text-[10px] text-slate-400 block mt-1">Class Test 2</span>
                        </div>
                        ...
                        <div className="bg-slate-50/70 border border-slate-200/90 rounded-2xl p-3.5 focus-within:bg-white focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/10 transition-all shadow-2xs">
                          ...
                          <input
                            ...
                            className="w-full text-lg font-black text-slate-900 bg-transparent focus:outline-none"
                          />
                          <span className="text-[10px] text-slate-400 block mt-1">Direct Out of 10</span>
                        </div>
                        ...
                        <div className="bg-slate-50/70 border border-slate-200/90 rounded-2xl p-3.5 focus-within:bg-white focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/10 transition-all shadow-2xs">
                          ...
                          <input
                            ...
                            className="w-full text-lg font-black text-slate-900 bg-transparent focus:outline-none"
                          />
                          <span className="text-[10px] text-slate-400 block mt-1">Scaled as ECA / 7</span>
                        </div>
                      </div>
                    </div>

                    {/* Result Summary & Formula Banner */}
                    <div className="bg-gradient-to-r from-blue-50/90 via-indigo-50/50 to-blue-50/80 border border-blue-100 rounded-2xl p-4 sm:p-5 shadow-2xs space-y-3">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                        <div>
                          ...
                          <div className="flex items-baseline space-x-2">
                            ...
                            <span className="text-sm font-bold text-blue-500/80 font-mono">/ 30 Marks</span>
                          </div>
                        </div>
                        <div className="text-xs font-mono font-semibold text-slate-600 bg-white/95 px-3 py-1.5 rounded-xl border border-blue-100 shadow-2xs self-start sm:self-auto">
                      ...
                      <div className="grid grid-cols-3 gap-2.5 pt-1">
                        <div className="bg-white rounded-xl p-2.5 border border-slate-200/80 shadow-2xs text-center sm:text-left">
                  ...
                  <div className="w-full flex-shrink-0 p-6 sm:p-8 flex flex-col justify-between space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
                      ...
                      <div className="bg-emerald-50 border border-emerald-200/80 rounded-2xl px-3.5 py-2 text-right self-start sm:self-auto shadow-2xs">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
                      {/* D / Pass */}
                      <div className="bg-rose-50/60 border border-rose-100/90 rounded-2xl p-4 flex items-center justify-between hover:scale-[1.02] transition-transform shadow-2xs">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="flex items-center space-x-1.5">
                              <span className="text-xs font-bold text-slate-900">To Pass</span>
                              <span className="text-[10px] font-mono text-rose-700 bg-rose-100/70 px-1.5 py-0.2 rounded font-semibold">49-40</span>
                            </div>
                            <span className="text-[11px] text-slate-500 block mt-0.5">Min 40 overall aggregate</span>
                          </div>
                        </div>
                      ...
                      {/* C / 6 Pointer */}
                      <div className="bg-amber-50/60 border border-amber-100/90 rounded-2xl p-4 flex items-center justify-between hover:scale-[1.02] transition-transform shadow-2xs">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="flex items-center space-x-1.5">
                              <span className="text-xs font-bold text-slate-900">6 Pointer</span>
                              <span className="text-[10px] font-mono text-amber-700 bg-amber-100/70 px-1.5 py-0.2 rounded font-semibold">59-50</span>
                            </div>
                            <span className="text-[11px] text-slate-500 block mt-0.5">Fair grade cutoff</span>
                          </div>
                        </div>
                      ...
                      {/* B / 7 Pointer */}
                      <div className="bg-purple-50/60 border border-purple-100/90 rounded-2xl p-4 flex items-center justify-between hover:scale-[1.02] transition-transform shadow-2xs">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="flex items-center space-x-1.5">
                              <span className="text-xs font-bold text-slate-900">7 Pointer</span>
                              <span className="text-[10px] font-mono text-purple-700 bg-purple-100/70 px-1.5 py-0.2 rounded font-semibold">69-60</span>
                            </div>
                            <span className="text-[11px] text-slate-500 block mt-0.5">Good grade cutoff</span>
                          </div>
                        </div>
                      ...
                      {/* A / 8 Pointer */}
                      <div className="bg-blue-50/60 border border-blue-100/90 rounded-2xl p-4 flex items-center justify-between hover:scale-[1.02] transition-transform shadow-2xs">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="flex items-center space-x-1.5">
                              <span className="text-xs font-bold text-slate-900">8 Pointer</span>
                              <span className="text-[10px] font-mono text-blue-700 bg-blue-100/70 px-1.5 py-0.2 rounded font-semibold">79-70</span>
                            </div>
                            <span className="text-[11px] text-slate-500 block mt-0.5">Very Good grade cutoff</span>
                          </div>
                        </div>
                      ...
                      {/* E / 9 Pointer */}
                      <div className="bg-teal-50/60 border border-teal-100/90 rounded-2xl p-4 flex items-center justify-between hover:scale-[1.02] transition-transform shadow-2xs">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="flex items-center space-x-1.5">
                              <span className="text-xs font-bold text-slate-900">9 Pointer</span>
                              <span className="text-[10px] font-mono text-teal-700 bg-teal-100/70 px-1.5 py-0.2 rounded font-semibold">89-80</span>
                            </div>
                            <span className="text-[11px] text-slate-500 block mt-0.5">Excellent grade cutoff</span>
                          </div>
                        </div>
                        <div className="text-base sm:text-lg font-black text-teal-600 font-mono">
                          {formatTargetScore(previewCalc.eNeeded)}
                        </div>
                      </div>

                      {/* O / 10 Pointer */}
                      <div className="bg-emerald-50/60 border border-emerald-100/90 rounded-2xl p-4 flex items-center justify-between hover:scale-[1.02] transition-transform shadow-2xs">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="flex items-center space-x-1.5">
                              <span className="text-xs font-bold text-slate-900">10 Pointer</span>
                              <span className="text-[10px] font-mono text-emerald-700 bg-emerald-100/70 px-1.5 py-0.2 rounded font-semibold">100-90</span>
                            </div>
                            <span className="text-[11px] text-slate-500 block mt-0.5">Outstanding grade</span>
                          </div>
                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
                      <button
                        type="button"
                        onClick={() => setActiveSlide(0)}
                        className="text-xs font-bold text-slate-600 hover:text-slate-900 flex items-center space-x-1.5 cursor-pointer py-1"
                      >
                        <ChevronLeft className="w-4 h-4" />
                      ...
                      <div className="flex items-center space-x-2.5">
                        <button
                          type="button"
                          onClick={() => setActiveSlide(2)}
                          className="text-xs font-bold text-blue-600 hover:text-blue-700 px-3 py-2 cursor-pointer"
                        >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
                      ...
                      <div className="flex items-center space-x-2 self-start sm:self-auto">
                        <select
                          ...
                          className="text-xs font-bold text-slate-800 bg-white border border-slate-200 rounded-xl px-3 py-2 shadow-2xs focus:outline-none focus:border-blue-500 cursor-pointer"
                        >
                          {BRANCHES.map((b) => (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
                      {explorerSubjects.slice(0, 6).map((subj) => (
                        <div
                          key={subj.id}
                          onClick={onGetStarted}
                          className="bg-white border border-slate-200/90 hover:border-blue-300 rounded-2xl p-4 shadow-2xs hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between space-y-3"
                        >
                          <div>
                          ...
                          <div className="flex items-center justify-between pt-2.5 border-t border-slate-100 text-xs font-bold text-blue-600">
              ...
              <div className="bg-slate-50/80 border-t border-slate-100 px-6 py-3.5 flex items-center justify-between text-xs text-slate-500">
                {/* Progress Indicators */}
                <div className="flex items-center space-x-2">
                  {[0, 1, 2].map((idx) => (
                    <button
                  ...
                  <span className="text-[11px] font-semibold text-slate-400 pl-1.5">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    type="button"
                    onClick={onGetStarted}
                    className="text-xs font-bold text-blue-600 hover:text-blue-700 cursor-pointer inline-flex items-center space-x-1"
                  >
